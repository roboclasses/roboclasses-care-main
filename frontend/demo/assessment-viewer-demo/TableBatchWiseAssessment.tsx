...
//   const [role, setRole] = useState('teacher')
  const { data: assessmentData= [], isLoading, isValidating, error } = useSWR<AssessmentType[]>(AssessmentUrl,fetcher);
    ...
    <Table className="border border-black">
      ...
      <TableBody>
        {assessmentData?.map((assessment: AssessmentType) => (
          <TableRow key={assessment._id}>
            ...
            <TableCell className="font-medium">{assessment.assessmentLevel}</TableCell>
      ...
      <TableFooter>
        <TableRow>
          ...
          <TableCell className="text-right">{assessmentData.length}</TableCell>
        </TableRow>
      </TableFooter>
    </Table>
    </div>
