...
const FormSchema = z.object({
  date: z.string(),
  userName: z.string().min(3, { message: "Student or Parent name must be atleast 3 character long" }),
  destination: z
  .string()
  ...
  course: z.string().min(2, { message: "Course name must be atleast 2 character long" }),
  teacher: z.string().min(3, { message: "Teacher name must be atleast 3 character long" }),
  time: z.string(),
  timeZone: z.string(),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  This field is for full name. This will displayed 
                  in demo-class table.
                </FormDescription>
                <FormMessage />
              </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    This field is for mobile number. This will displayed in demo-class table.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This field is for course. This will displayed  in demo-class table.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                ...
                <FormDescription>This field is for teacher&apos;s name. This will displayed  in demo-class table.</FormDescription>
                <SelectContent>
                  {role === "teacher" ? (
          ...
          render={({ field }) => (
            <FormItem>
              ...
              >
                ...
                <FormDescription>This drop-down field is for available timezones.</FormDescription>
                <SelectContent>
                  {timezone.map((item) => (
                    <SelectItem value={item.name} key={item.id}>
                      {item.country}
